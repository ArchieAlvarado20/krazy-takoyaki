        ...
        background-color: #182736;
                     ...
                     <div class="nav-item dropdown col-5">
                        ...
                        <img class="rounded-circle me-lg-2" src="<?= auth('image')?>" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex text-white"><?= auth('name')?></span>&nbsp;
    
                        </a>
                        <div class="dropdown-menu dropdown-menu-start bg-secondary border-0 rounded-0 rounded-bottom m-0 text-right">
