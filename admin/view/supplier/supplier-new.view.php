        ...
        <div class="card shadow  bg-secondary ">
              ...
              <div class="card-body">
                    <div class="card-header mb-3">
                      <div class="row mb-2">
                        <div class="col-sm-12">
                          <h4 class="fw-bold text-center text-primary" style="font-weight: bolder;"><strong><i class="fa fa-boxes-packing"></i> Add New Supplier</strong></h4>
                        </div>
                      </div>
                    </div>
               <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row d-flex mb-4 px-3">
                  <div class="col-sm-6">
                      <a href="index.php?pg=supplier"><button type="button" class="btn btn-dark border-primary text-primary px-5">
                            Back
                          </button></a>
                  </div>
                  <div class="col-sm-6">
                <button class="btn btn-dark border-primary text-primary px-5 float-end">Save</button>
                  </div>
              </div>
