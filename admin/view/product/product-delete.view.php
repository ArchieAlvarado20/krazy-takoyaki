     ...
     <section class="content-header">
      <div class="container col-md-8 mt-5">
        ...
        <div class="card-header text-center text-secondary p-3">
                    <h3 class="mb-3 text-primary"><strong><i class="fa fa-hamburger"></i> Delete Product</strong></h3>
                    <div class="alert bg-dark text-primary text-center alert-dismissible fade show mb-1" role="alert">Are you sure you want to delete this product?
              ...
              <form action="" method="POST" enctype="multipart/form-data">
               ...
               <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="price" id="price" class="form-control price bg-dark" autocomplete="off" value="<?=set_value('price',$row['price'])?>" readonly>
                </div>
                <div class="mb-3 row">
